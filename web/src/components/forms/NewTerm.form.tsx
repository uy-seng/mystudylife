...
import css from "./NewTerm.form.module.css";
import { getMonthName, isValidDateFormat } from "../../utils";
...
const NewTermForm = connect(mapStateToProps, mapDispatchToProps)(MyForm);
