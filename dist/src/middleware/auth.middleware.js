...
export var authenticationGate = function (_a, next) {
    var context = _a.context;
    return __awaiter(void 0, void 0, void 0, function () {
        var accessToken, decodedPayload, userRepository, user, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    decodedPayload = verify(accessToken, process.env.ACCESS_TOKEN_SECRET);
                    context.user = decodedPayload.user;
                    userRepository = getConnection(process.env.NODE_ENV).getRepository(User);
                    return [4, userRepository.findOne(decodedPayload.user.id)];
                case 2:
                    user = _b.sent();
                ...
                case 3:
                    e_1 = _b.sent();
                    throw new AuthenticationError(e_1.message);
