...
var ClassScheduleResolver = (function () {
    function ClassScheduleResolver() {
        this.classScheduleRepository = getConnection(process.env.NODE_ENV).getRepository(ClassSchedule);
    }
    ClassScheduleResolver.prototype.newClassSchedule = function (_a) {
        var type = _a.type, classId = _a.classId;
        return __awaiter(this, void 0, void 0, function () {
            var newClassSchedule;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        newClassSchedule = this.classScheduleRepository.create({
                            classId: classId,
                            type: type,
                        });
                        return [4, this.classScheduleRepository.save(newClassSchedule)];
    ...
    __decorate([
        Mutation(function () { return ClassSchedule; }),
