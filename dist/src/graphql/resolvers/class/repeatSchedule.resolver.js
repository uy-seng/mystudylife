...
var RepeatScheduleResolver = (function () {
    function RepeatScheduleResolver() {
        this.repeatScheduleRepository = getConnection(process.env.NODE_ENV).getRepository(RepeatSchedule);
    }
    RepeatScheduleResolver.prototype.newRepeatSchedule = function (_a) {
        var startTime = _a.startTime, endTime = _a.endTime, repeatDays = _a.repeatDays, scheduleId = _a.scheduleId, startDate = _a.startDate, endDate = _a.endDate, rotationWeek = _a.rotationWeek;
        return __awaiter(this, void 0, void 0, function () {
            var repeatSchedule;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        repeatSchedule = this.repeatScheduleRepository.create({
                            startTime: startTime,
                            endTime: endTime,
                        ...
                        return [4, this.repeatScheduleRepository.save(repeatSchedule)];
                    case 1: return [2, _b.sent()];
                }
            });
        });
    };
    RepeatScheduleResolver.prototype.updateRepeatSchedule = function (id, updateContext, _a) {
        var user = _a.user;
        return __awaiter(this, void 0, void 0, function () {
            var q;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, this.repeatScheduleRepository.findOne(id, {
                    ...
                    case 1:
                        ...
                        return [4, this.repeatScheduleRepository.save(q)];
                    case 2:
                        _b.sent();
                        return [2, true];
                }
    ...
    RepeatScheduleResolver.prototype.deleteRepeatSchedule = function (id, _a) {
        var user = _a.user;
        return __awaiter(this, void 0, void 0, function () {
            var q;
            return __generator(this, function (_b) {
    ...
    __decorate([
        Mutation(function () { return RepeatSchedule; }),
