...
let AcademicYearScheduleResolver = class AcademicYearScheduleResolver {
    scheduleRepository = (0, typeorm_1.getConnection)(process.env.NODE_ENV).getRepository(entity_1.AcademicYearSchedule);
    weekRotationScheduleRepository = (0, typeorm_1.getConnection)(process.env.NODE_ENV).getRepository(entity_1.WeekRotationSchedule);
    dayRotationScheduleRepository = (0, typeorm_1.getConnection)(process.env.NODE_ENV).getRepository(entity_1.DayRotationSchedule);
