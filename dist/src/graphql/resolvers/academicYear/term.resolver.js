...
var TermResolver = (function () {
    function TermResolver() {
        this.termRepository = getConnection(process.env.NODE_ENV).getRepository(Term);
    }
    TermResolver.prototype.newTerm = function (_a) {
        var academicYearId = _a.academicYearId, name = _a.name, startDate = _a.startDate, endDate = _a.endDate;
        return __awaiter(this, void 0, void 0, function () {
            var newTerm;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        newTerm = this.termRepository.create({
                            academicYearId: academicYearId,
                            name: name,
                            startDate: startDate,
                            endDate: endDate,
                        });
                        return [4, this.termRepository.save(newTerm)];
