...
var WeekRotationSchedule = (function () {
    function WeekRotationSchedule() {
    }
    __decorate([
    ...
    __decorate([
        OneToOne(function () { return AcademicYearSchedule; }, function (schedule) { return schedule.weekRotation; }, {
            onDelete: "CASCADE",
        }),
    ...
    return WeekRotationSchedule;
}());
export { WeekRotationSchedule };
